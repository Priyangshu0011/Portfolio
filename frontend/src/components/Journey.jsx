    ...
    <section id="journey" className="py-20 px-4 max-w-6xl mx-auto relative z-10 font-sans">
      ...
      >
        <h2 className="text-3xl md:text-5xl font-bold text-white uppercase tracking-wider mb-2 relative inline-block">
          ...
          <div className={`absolute -bottom-2 left-1/2 -translate-x-1/2 w-full h-[1px] bg-gradient-to-r from-transparent ${isDark ? 'via-faint-yellow' : 'via-red-500'} to-transparent`}></div>
        </h2>
